...
export default async function ContactPage() {
  ...
  return (
    <div className="space-y-8 pb-10">
      <PageHero eyebrow={page?.eyebrow || 'Contact'} title={page?.title || 'Contact'} summary={page?.summary || ''} />

      <section className="grid gap-5 lg:grid-cols-[0.75fr_0.75fr_1.1fr]">
        ...
        <div className="rounded-[1.8rem] bg-[linear-gradient(165deg,#274b3a_0%,#1c3529_100%)] p-6 text-ivory shadow-[0_22px_56px_rgba(18,27,22,0.18)]">
          <p className="text-xs font-semibold uppercase tracking-[0.3em] text-stone-400">{copy.contact.panelEyebrow}</p>
        ...
        <div className="space-y-4">
          <div className="rounded-[1.8rem] border border-white/85 bg-white/88 p-6 shadow-[0_16px_44px_rgba(23,35,29,0.08)]">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-olive-600">{copy.contact.sendMessage}</p>
